...
export function AlignmentPanel({
  ...
  if (!isAlignable) {
    return (
      <div className="shrink-0 rounded-md border border-amber-300 bg-amber-50 p-2 text-[10px] text-amber-700">
        🔧 Alignment mode is active. Select any clothing category (top, bottom, dress, coat, shoe, accessory, decoration, or hairstyle) to adjust its position.
      </div>
    )
  }
  ...
  return (
    <div className="shrink-0 rounded-md border-2 border-amber-400 bg-amber-50 p-2.5 shadow-sm">
      ...
      {/* Controls help table (collapsible) */}
      {showHelp && (
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-t border-stone-200">
                <td>Shift + ↑↓←→</td><td>Fast move</td><td className="text-right">×10</td>
              </tr>
